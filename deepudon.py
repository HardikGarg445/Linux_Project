...
class PortScannerApp:
    ...
    def init_ui(self):
        ...
        self.percentage_txt = self.circle_canvas.create_text(90, 70, text="0%", font=("Arial", 30, "bold"), fill="#FFFFFF")
        self.label_txt = self.circle_canvas.create_text(90, 110, text="Progress", font=("Arial", 14), fill="#FFFFFF")
        ...
        self.start_button = ctk.CTkButton(btn_frame, text="Start Scan", command=self.start_scan, width=150, height=40, font=self.custom_font)
